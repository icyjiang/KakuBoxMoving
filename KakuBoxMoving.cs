...
namespace KakuBoxMoving
{
    public class KakuBoxState : BoxState
    {
        ...
        public KakuBoxState(Point kaku, IEnumerable<Point> boxs)
            : base(boxs)
        {
            this.kaku = kaku;
        }
        ...
        public override bool IsMeetMap(Map map)
        {
    ...
    public class KakuMovingCheckPolicy : IMovingCheckingPolicy
    {
        ...
        public KakuMovingCheckPolicy(Map map)
        {
        ...
        public bool Check(BoxMovingStep movingStep)
        {
            ...
            if (thisStep == null) throw new InvalidOperationException("KakuMovingCheckPolicy only check KakuBoxMovingStep.");
